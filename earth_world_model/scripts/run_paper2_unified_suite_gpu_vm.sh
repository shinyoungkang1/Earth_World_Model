...
GCS_RUNS_ROOT="${GCS_RUNS_ROOT:-gs://omois-earth-world-model-phase2-20260320-11728/earth_world_model/runs/paper2_sigreg_suite_${DEFAULT_RUN_STAMP}}"
...
run_sigreg() {
  ...
  run_one \
    ...
    EWM_REG_S1_PRIVATE_DIM=1024 \
    EWM_REG_SHARED_DIM=1024 \
    EWM_REG_S2_PRIVATE_DIM=1024 \
    "$@"
}
...
if [[ "$RUN_ARCH_ABLATIONS" == "1" ]]; then
  ...
  run_sigreg \
    "mixed_ssl4eo_yearly_${YEARLY_TRAIN_MAX_SAMPLES}_alt_dims_512_512_512" \
    EWM_REG_S1_PRIVATE_DIM=512 \
    EWM_REG_SHARED_DIM=512 \
    EWM_REG_S2_PRIVATE_DIM=512
fi
