#!/usr/bin/env python3
"""Run the basin-scoped gas v1 pipeline end to end."""
...
def main() -> int:
    ...
    steps = [
        ["python", "scripts/build_gas_training_table_v1.py", "--basin-id", args.basin_id],
        ["python", "scripts/train_gas_baseline_v1.py", "--basin-id", args.basin_id],
        ["python", "scripts/score_gas_prospect_cells_v1.py", "--basin-id", args.basin_id],
